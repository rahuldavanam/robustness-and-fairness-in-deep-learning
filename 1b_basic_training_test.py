...
if __name__ == '__main__':
    ...
    plot_confusion_matrix(targets_tensor, y_pred_tensor, class_names, title="Confusion matrix of basic training on benign data", filename="Confusion_matrix_of_basic_training_on_benign_data.png")

    # Untargeted confusion matrix
    plot_confusion_matrix(targets_tensor, y_pred_untarget_adv_tensor, class_names, title="Confusion matrix of basic training on untargeted data", filename="Confusion_matrix_of_basic_training_on_untargeted_data.png")
