...
file_name = 'loss_norms_untargeted_l2'
...
if __name__ == '__main__':
    ...
    plot_confusion_matrix(targets_tensor, y_pred_tensor, class_names, title="Confusion matrix of l2 loss untargeted training on benign data", filename="Confusion_matrix_of_l2_loss_untargeted_training_on_benign_data.png")
    
    # Untargeted confusion matrix
    plot_confusion_matrix(targets_tensor, y_pred_untarget_adv_tensor, class_names, title="Confusion matrix of l2 loss untargeted training on untargeted data", filename="Confusion_matrix_of_l2_loss_untargeted_training_on_untargeted_data.png")
   
    # Targeted confusion matrix
    plot_confusion_matrix(targets_tensor, y_pred_target_adv_tensor, class_names, title="Confusion matrix of l2 loss untargeted training on targeted data", filename="Confusion_matrix_of_l2_loss_untargeted_training_on_targeted_data.png")